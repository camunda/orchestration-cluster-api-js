 ...
 *
 */
export const getIncidentProcessInstanceStatistics = <ThrowOnError extends boolean = true>(options?: Options<GetIncidentProcessInstanceStatisticsData, ThrowOnError>) => {
    return (options?.client ?? client).post<GetIncidentProcessInstanceStatisticsResponses, GetIncidentProcessInstanceStatisticsErrors, ThrowOnError>({
        requestValidator: undefined,
        responseValidator: undefined,
