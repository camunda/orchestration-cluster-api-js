 ...
 */
export const zClusterVariableKindEnum = z.enum([
    'JSON',
    'SECRET_REFERENCE'
]).register(z.globalRegistry, {
 ...
 *
 */
export const zLoopIterationId = z.int().gte(1).register(z.globalRegistry, {
 ...
 *
 */
export const zTenantFilterEnum = z.enum([
    'PROVIDED',
    'ASSIGNED'
]).register(z.globalRegistry, {
...
export const zBatchOperationResponse = z.object({
    ...
    operationsTotalCount: z.int().register(z.globalRegistry, {
        description: 'The total number of items contained in this batch operation.'
    }),
    operationsFailedCount: z.int().register(z.globalRegistry, {
    ...
    operationsCompletedCount: z.int().register(z.globalRegistry, {
...
export const zDeleteDecisionInstanceRequest = z.union([
    z.object({
...
export const zSuspendProcessInstanceRequest = z.union([
    z.object({
        operationReference: z.optional(zOperationReference)
    }),
    z.null()
...
export const zResumeProcessInstanceRequest = z.union([
    z.object({
        operationReference: z.optional(zOperationReference)
    }),
    z.null()
...
export const zUpdateGlobalClusterVariableData = z.object({
...
export const zSearchClusterVariablesData = z.object({
    body: z.optional(zClusterVariableSearchQueryRequest),
    path: z.optional(z.never()),
...
export const zUpdateTenantClusterVariableData = z.object({
    body: zUpdateClusterVariableRequest,
    path: z.object({
        tenantId: zTenantId,
        name: zClusterVariableName
...
export const zDeleteDecisionInstancesBatchOperationData = z.object({
    body: zDecisionInstanceDeletionBatchOperationRequest,
    path: z.optional(z.never()),
    query: z.optional(z.never())
});
...
export const zGetJobErrorStatisticsData = z.object({
...
export const zGetProcessDefinitionMessageSubscriptionStatisticsData = z.object({
    body: z.optional(zProcessDefinitionMessageSubscriptionStatisticsQuery),
    path: z.optional(z.never()),
    query: z.optional(z.never())
});
...
export const zGetProcessDefinitionInstanceStatisticsData = z.object({
    body: z.optional(zProcessDefinitionInstanceStatisticsQuery),
    path: z.optional(z.never()),
    query: z.optional(z.never())
});
...
export const zSearchProcessDefinitionVariableNamesData = z.object({
...
export const zGetProcessDefinitionInstanceVersionStatisticsData = z.object({
    body: zProcessDefinitionInstanceVersionStatisticsQuery,
    path: z.optional(z.never()),
    query: z.optional(z.never())
});
...
export const zDeleteProcessInstancesBatchOperationData = z.object({
    body: zProcessInstanceDeletionBatchOperationRequest,
    path: z.optional(z.never()),
    query: z.optional(z.never())
});
...
export const zResumeProcessInstancesBatchOperationData = z.object({
...
export const zSuspendProcessInstancesBatchOperationData = z.object({
...
export const zAssignProcessInstanceBusinessIdData = z.object({
...
export const zResumeProcessInstanceData = z.object({
...
export const zSuspendProcessInstanceData = z.object({
...
export const zResolveSecretsData = z.object({
...
export const zGetSystemConfigurationData = z.object({
    body: z.optional(z.never()),
    path: z.optional(z.never()),
    query: z.optional(z.never())
});
...
export const zChangeClusterModeData = z.object({
    body: z.optional(z.never()),
    path: z.optional(z.never()),
    query: z.object({
        mode: z.enum([
...
export const zRestoreData = z.object({
...
export const zSearchUserTaskAuditLogsData = z.object({
    body: z.optional(zUserTaskAuditLogSearchQueryRequest),
    path: z.object({
        userTaskKey: zUserTaskKey
    }),
    query: z.optional(z.never())
