 ...
 * @tags Cluster
 */
export function getClusterUpgradeStatus(options?: Parameters<typeof _getClusterUpgradeStatus>[0]): CancelablePromise<_DataOf<typeof _getClusterUpgradeStatus>> {
  return toCancelable(signal => _getClusterUpgradeStatus({ ...(options||{}), signal } as any).then((r:any)=> (r as any).data));
}
...
// SENTINEL_FACADE_PREWRITE hash=d7c739fc1848f121 totalWrappers=244 elements=1508 physicalLines=3901
