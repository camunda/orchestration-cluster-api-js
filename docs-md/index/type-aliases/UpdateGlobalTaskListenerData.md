...
# Type Alias: UpdateGlobalTaskListenerData

```ts
type UpdateGlobalTaskListenerData = object;
```

Defined in: [gen/types.gen.ts:10729](https://github.com/camunda/orchestration-cluster-api-js/blob/686113e38ceaeea2abb1cc7d02a0ac8a78313121/src/gen/types.gen.ts#L10729)
...
Defined in: [gen/types.gen.ts:10731](https://github.com/camunda/orchestration-cluster-api-js/blob/686113e38ceaeea2abb1cc7d02a0ac8a78313121/src/gen/types.gen.ts#L10731)
