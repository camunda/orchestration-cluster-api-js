...
| `CAMUNDA_SDK_LOG_LEVEL` | enum(silent \| error \| warn \| info \| debug \| trace \| silly) | `info` | Optional |  | SDK log level. "silly" adds unsafe deep diagnostics including HTTP request and response bodies. |
